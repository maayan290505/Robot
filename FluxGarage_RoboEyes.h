...
void setPosition(unsigned char position)
  {
    ...
    case N:
      // North, top center
      eyeLxNext = getScreenConstraint_X_next()/2;
      eyeLyNext = 0;
      break;
    case NE:
      // North-east, top right
      eyeLxNext = getScreenConstraint_X_next();
      eyeLyNext = 0;
      break;
    case E:
      // East, middle right
...
int getScreenConstraint_X_next(){
  return screenWidth - eyeLwidthNext - spaceBetweenNext - eyeRwidthNext;
}
